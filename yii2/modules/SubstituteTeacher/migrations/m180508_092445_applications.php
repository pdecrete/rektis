...
class m180508_092445_applications extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%stapplication}}', [
            ...
            'reference' => $this->text()->notNull(), // json holding mainly frontend id and other info
        ...
        $this->createTable('{{%stapplication_position}}', [
            'id' => $this->primaryKey(),
        ...
        $this->addForeignKey('fk_application_id', '{{%stapplication_position}}', 'application_id', '{{%stapplication}}', 'id', 'SET NULL', 'CASCADE');
        $this->addForeignKey('fk_call_position_id', '{{%stapplication_position}}', 'call_position_id', '{{%stcall_position}}', 'id', 'SET NULL', 'CASCADE');
    }

    public function safeDown()
    {
        $this->dropTable('{{%stapplication_position}}');
