...
$this->params['breadcrumbs'][] = ['label' => Yii::t('substituteteacher', 'Stteacher Mkexperiences'), 'url' => ['stteacher-mkexperience/index']];
...
<div class="file-preview">
    ...
    <h1>
        <small>Οι επιλογές παρακάτω αφορούν στοιχεία
            <strong>προϋπηρεσιών αναπληρωτών</strong>
        </small>
    </h1>
    <p>
        ...
        Html::button(Yii::t('substituteteacher', 'Import data'), [
            ...
            'data' => [
                ...
                'dbtnconfirm' => Yii::t('substituteteacher', 'Clear previous experiences and import? Are you certain?')
            ],
        ])
...
Modal::begin([
    ...
    'header' => '<h3>' . Yii::t('substituteteacher', 'Select year of mk experiences') . '</h3>',
    ...
    <div class="row">
        <div class="col-sm-12">
            <p class="text-warning">
                <?= Yii::t('substituteteacher', 'After selecting the year, all existing mk experiences of the selected teachers in that year will be cleared before import.') ?>
            </p>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12 text-right">
            <div class="form-group">
                ...
                Html::submitButton(Yii::t('substituteteacher', 'Import'), [
                    ...
                    'class' => 'btn btn-primary',
                    'data-confirm' => Yii::t('substituteteacher', 'Clear previous mk experiences and import? Are you certain?'),
                ])
