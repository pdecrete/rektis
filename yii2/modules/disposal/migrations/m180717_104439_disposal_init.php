        ...
        */
        ...
        $create_command = "CREATE TABLE IF NOT EXISTS " . $dbDisposalTables['table_disposal'] .
                          " (`disposal_id` INTEGER NOT NULL AUTO_INCREMENT,
                             ...
                             `disposal_hours` TINYINT COMMENT 'Ώρες Διάθεσης',
                             `disposal_days` TINYINT NOT NULL COMMENT 'Μέρες Διάθεσης',
                             ...
                             `fromschool_id` INTEGER NOT NULL,
                             `toschool_id` INTEGER NOT NULL,
                             ...
                             `localdirdecision_id` INTEGER NOT NULL,
                              ...
                              FOREIGN KEY (`fromschool_id`) REFERENCES " . $table_schoolunit . " (`school_id`) ON DELETE RESTRICT ON UPDATE RESTRICT " . ",
                              FOREIGN KEY (`toschool_id`) REFERENCES " . $table_schoolunit . " (`school_id`) ON DELETE RESTRICT ON UPDATE RESTRICT " . ",
