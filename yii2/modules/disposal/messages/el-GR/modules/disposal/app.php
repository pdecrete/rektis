...
return [
    ...
    'Approval-Decision' => 'Έγκριση-Απόφαση',
    'Approvals-Decisions' => 'Εγκρίσεις-Αποφάσεις',
    ...
    'Disposals Approvals-Decisions' => 'Εγκρίσεις-Αποφάσεις Διαθέσεων',
    ...
    'Create Disposals\' Approval-Decision' => 'Δημιουργία Έγκρισης-Απόφασης',
    ...
    'Disposals for Approval-Decision' => 'Διαθέσεις προς Έγκριση-Απόφαση',
    'Processed Disposals' => 'Διεκπεραιωμένες Διαθέσεις',
    'The document was deleted succesfully and the disposals included in it where set back to the "Disposals for Approval-Decision" section (not for republished documents for which the state is simply set back to the prior republication state).' => 'Το έγγραφο των διαθέσεων διαγράφηκε επιτυχώς και οι διαθέσεις που περιλαμβάνονταν σε αυτή επιστράφησαν στην ενότητα "Διαθέσεις προς Έγκριση-Απόφαση" (δεν ισχύει για ανακοινοποιημένα έγγραφα όπου η κατάσταση των διαθέσεων επιστρέφεται στην κατάσταση πριν την ανακοινοποίηση).',
    ...
    'The document of the disposals was created successfully.' => 'Το έγγραφο των διαθέσεων δημιουργήθηκε επιτυχώς.',
    'The document of the disposals was updated successfully.' => 'Το έγγραφο των διαθέσεων ενημερώθηκε επιτυχώς.',
    ...
    'Download Decision' => 'Κατέβασμα Απόφασης',
    'The creation of the approval-decision failed, because the template file does not exist.' => 'Η δημιουργία της έγκρισης-απόφασης απέτυχε επειδή δεν υπάρχει το πρότυπο αρχείο για τη δημιουργία της.',
    'Update Disposals\' Approval-Decision' => 'Ενημέρωση Έγκρισης-Απόφασης',
    'Organic Post Directorate' => 'Δ/νση Οργανικής',
    'Directorate' => 'Δ/νση',
    'View Approval-Decision' => 'Προβολή Έγκρισης-Απόφασης',
    ...
    'Manage disposals under approval-decision' => 'Διαχείριση των προς έγκριση-απόφαση διαθέσεων',
    'Manage disposals approvals-decisions' => 'Διαχείριση Εγκρίσεων-Αποφάσεων Διαθέσεων',
    ...
    'Restore Disposal in "under approval-decision" state' => 'Επαναφορά διάθεσης σε "προς έγκριση-απόφαση" κατάσταση',
    ...
    'Archive' => 'Αρχειοθέτηση',
    'Archived Approvals-Decisions' => 'Αρχειοθετημένες Εγκρίσεις-Αποφάσεις',
    ...
    'Not allowed action for that document.' => 'Μη επιτρεπτή ενέργεια για αυτό το έγγραφο.',
    'An invalid period value was given to export data.' => 'Μη έγκυρη τιμή περιόδου δόθηκε για την εξαγωγή δεδομένων.',
    'From-To' => 'Από-Έως',
    'The document was republished successfully.' => 'Το έγγραφο ανακοινοποιήθηκε επιτυχώς.',
    'The creation of the document failed, because the template file does not exist.' => 'Η δημιουργία του εγγράφου απέτυχε, επειδή δεν βρέθηκε το πρότυπο αρχείο.',
    'Failed to save the approval/decision.' => 'Αποτυχία αποθήκευσης της έγκρισης/απόφασης',
    'Failed to assign disposals to the approval-decision.' => 'Αποτυχια συσχέτισης των διαθέσεων σε έγκριση-απόφαση.'
];
