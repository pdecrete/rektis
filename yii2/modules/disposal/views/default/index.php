...
<div class="body-content">
	<div class="row">
  	...
  	<div class="row">
        <div class="col-lg-4">
            <h3><?= DisposalModule::t('modules/disposal/app', 'Local Directorate Suggestions');?></h3>
            <p><?= DisposalModule::t('modules/disposal/app', 'View school units as retrieved from myschool');?></p>
			<p><?= Html::a(DisposalModule::t('modules/disposal/app', 'Local Directorate Suggestions'), Url::to(['/disposal/disposal-localdirdecision']), ['class' => 'btn btn-primary', 'data-method' => 'post']) ?></p>
        </div>
        <div class="col-lg-4">
