...
<div class="body-content">
    <div class="row">
		<div class="col-lg-4">
			...
			<p><?= Html::a(DisposalModule::t('modules/disposal/app', 'Disposal Approvals'), Url::to(['/disposal/disposal']), ['class' => 'btn btn-primary', 'data-method' => 'post']) ?></p>
        </div>
		<div class="col-lg-4">
    ...
    <div class="row">
        <div class="col-lg-4">
			...
			<p><?= Html::a(DisposalModule::t('modules/disposal/app', 'School Units'), Url::to(['/disposal/disposal-reason/']), ['class' => 'btn btn-primary', 'data-method' => 'post']) ?></p>
        </div>
        <div class="col-lg-4">
            <h3><?= DisposalModule::t('modules/disposal/app', 'Duties of Disposed Teachers');?></h3>
            <p><?= DisposalModule::t('modules/disposal/app', 'View school units as retrieved from myschool');?></p>
			<p><?= Html::a(DisposalModule::t('modules/disposal/app', 'School Units'), Url::to(['/disposal/disposal-workobj/']), ['class' => 'btn btn-primary', 'data-method' => 'post']) ?></p>
        </div>
        <div class="col-lg-4">
            <h3><?= DisposalModule::t('modules/disposal/app', 'Teachers');?></h3>
            <p><?= DisposalModule::t('modules/disposal/app', 'View school units as retrieved from myschool');?></p>
			<p><?= Html::a(DisposalModule::t('modules/disposal/app', 'School Units'), Url::to(['/teacher/']), ['class' => 'btn btn-primary', 'data-method' => 'post']) ?></p>
        </div>
    </div>
    <div class="row">    
        <div class="col-lg-4">
			...
			<p><?= Html::a(DisposalModule::t('modules/disposal/app', 'Transportation Approval States'), Url::to(['/disposal/disposal-state']), ['class' => 'btn btn-primary', 'data-method' => 'post']) ?></p>
        </div>    
    </div>
    <hr />
    <div class="row">
