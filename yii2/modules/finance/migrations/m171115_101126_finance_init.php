...
class m171115_101126_finance_init extends Migration
{
    ...
    public function safeUp()
    {
        ...
        Console::stdout("\n1. *** Creating table " . $dbFinTables['table_year'] . ". *** \n");
        ...
        Console::stdout("\n2. *** Creating table " . $dbFinTables['table_kae'] . ". *** \n");
        Console::stdout("SQL Command: " . $create_command . "\n");
        Yii::$app->db->createCommand($create_command)->execute();
        ...
        $create_command = "CREATE TABLE IF NOT EXISTS " . $dbFinTables['table_supplier'] .
                          "(`suppl_id` INTEGER NOT NULL AUTO_INCREMENT,
                            ...
                            `suppl_taxoffice` INTEGER NOT NULL,
        ...
        Console::stdout("\n8. *** Creating table " . $dbFinTables['table_deduction'] . ". *** \n");
        Console::stdout("SQL Command: " . $create_command . "\n");
        Yii::$app->db->createCommand($create_command)->execute();
        ...
        Console::stdout("\n10. *** Creating table " . $dbFinTables['table_state'] . ". *** \n");
        Console::stdout("SQL Command: " . $create_command . "\n");
        Yii::$app->db->createCommand($create_command)->execute();
