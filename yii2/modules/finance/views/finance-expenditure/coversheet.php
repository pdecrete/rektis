...
<table style="border: 0px; padding: 5 5 5 5px;">
	<tr><td colspan="2" style="text-align:center"><h5><strong><?= Yii::$app->params['pde_logo_literal']; ?><br />
	...
	<tr><td style="text-align:right">Πληροφορίες:</td><td><?= Yii::$app->params['fin_director']; ?></td></tr>
...
μας <strong>(<?= Yii::$app->params['finance_code']; ?>)</strong> συνολικού ποσού: <strong><?= Money::toCurrency($expenditure_model['exp_amount'], true); ?></strong>, στο όνομα του δικαιούχου "<strong><?= $supplier_model['suppl_name'] ?></strong>" και παρακαλούμε για τις δικές σας ενέργειες. 
</p>
<p>
