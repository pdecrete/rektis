...
<div class="schtransport-transport-view">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            'transport_teachers',
            'transport_students',
            'transport_localdirectorate_protocol',
            'transport_pde_protocol',
            'transport_remarks',
            'transport_datesentapproval',
            'transport_dateprotocolcompleted',
            'transport_approvalfile',
            'transport_signedapprovalfile',
            'meeting_id',
            'school_id',
        ],
    ]) ?>
